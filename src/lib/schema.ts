...
export const reportFormSchema = z.object({
  ...
  campaignHrsOrigTask: z.string().min(1, 'Required field'),
  campaignHrsOrigRedoTask: z.string().min(1, 'Required field'),
